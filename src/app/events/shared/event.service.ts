...
/*      getEventsHttp(): Observable<IEvent[]> {
      return this.http.get<IEvent[]>('/api/events').pipe(catchError(this.handleError<IEvent[]>('getEventsHttp', [])));
    }
 */
...
searchSession(searchTerm: string): Observable<any> {
